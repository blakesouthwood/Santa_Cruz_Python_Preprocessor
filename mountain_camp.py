...
print("this should return fudgy")
vartest ='''
...
def special_addition_to_digital_candy():
	...
	defaultlist.append(find_default)  #defaultlist[0] #here the default list is
	defaultlist.append(int(mystring)) #defaultlist[1]
	print("default list numbers are ",defaultlist)
...
switch_gen=''
varholder=[]
varholder.append("squaw")  #this has to be above the generated code
