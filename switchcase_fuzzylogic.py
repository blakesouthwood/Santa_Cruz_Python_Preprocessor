...
def parser_mode_1(a):
	mytrace('parser_mode_2 in switch_cat()') #was greatpumpkin
...
def endswitch(y): #pulls in sw 
	...
	if valve[0] == True: #this says numbers = True
		...
		# does parser for numbers like case 2:
		...
		print("valve[1]=",valve[1])
		#does parser for words like case "alpine meadows":
