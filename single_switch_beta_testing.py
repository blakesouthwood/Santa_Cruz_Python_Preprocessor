...
import single_switch_core
from single_switch_core  import *  
...
sw =''' 
	switch(exp) {
		...
		case 'COYOTE':
			print("Sesame Street")
			print(" groucho and animal")
			print("this is so fun") #see if it falls thru to lake tahoe no b r e a k
