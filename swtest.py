...
clever('snow time') #this would change varholder[0] 
...
sw ='''
	switch(exp) {
		...
		case 'snow time':
			...
			print("the snow at Tahoe is just beautiful")
			
		
		case 'have a cow':
			print('push the cow over before the ufo comes')
			print("going up...")
