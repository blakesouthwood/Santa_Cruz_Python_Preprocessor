...
print("made it to here line 10550")
output=[]
output.append(0)

nest_list=['red','white','blue','stars','stripes']
print("this is line number 10554 ===")
def testing_changing_item_in_list(x,y):
    print("what the..")
    print("testing this out listening to Nepture Currents")
    print('made it here testing changing item in list')
    output[0] = y  #daa so lame
    print("output[0] =",y)
    print("x=",x)
    nest_list[x] = output[0]
    print("nest_list=",nest_list)
    
print("nest_list=",nest_list)
    
testing_changing_item_in_list(0,"fish")
testing_changing_item_in_list(1,"starbucks")
testing_changing_item_in_list(2,"bicycle")
print('and now')
testing_changing_item_in_list(0,"the magic is real")

print("more testing here >.....")
initialize_lists()
output[0]= "trex"
#output[0] = input[0]
do_pipe() #puts output[0] into input[0]
print("lets see it=====",input[0], "should be trex") #should be trex
nice = input[0] #should be trex
input[0] = input[0] + " triceraptops"
output[0] = input[0]
do_pipe() #puts output into input
print("input=",input[0])
#input[0]= output[0]
...
Each method stage all fivr in sequence to a string

Chain the methods output to list [0]
Then that list is input to next method
Input[0] string methodname
