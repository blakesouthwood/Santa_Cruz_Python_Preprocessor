...
##############################
##     macro_expansion()       this calls convert_case_numbers_to_strings
...
def macro_expansion(y): #expands macros to and thru (if they exist)
	...
	if valve[0] == True:    #meaning numbers in cases is True
...
#cherry_pie outputs the expanded macros into cray[0]
	...
	# valve[0] contains the result of test for number in first case line
...
#		# calls parser
#		print("we will stop right here just after cherry pie.")
...
#		#just added the word to that means the same thing as thru
#		if  "case" and "thru" in line:  #on
#			list_with_0thru_macros.append(thru_counter)
#			thru_counter += 1
#		else:
#			thru_counter += 1
#			continue
...
######  converts numbers to strings case 1: to case '1': #####################
##############################################################################
#def case_numbers_to_strings1():
#	print("case_numbers_to_strings1() called")
#	mytrace('case_numbers_to_strings()')
#	global switchcasetester
#	print("=========testing case_numbers_to_strings===january 5th 2020====")
#	print("========  CASE NUMBERS TO STRINGS  ====")#go thru the entire string
...
def magictimenow_2():
	empty_list(line_numbers_of_first_cases)
	print('is this even called magictimenow_2')
...
def p51_mustang_2(): #makes critical cranberries list which is the taillist for switch cases
	...
	#and endswith(")")
	print('what is in royallist does it start with starter')
	print('royallist =',royallist)

	print("== STARBUCKS ==")
	print("what is in starbuckslist",starbuckslist)
	print("== STARBUCKS ==")
	#add starter to front of list
	#starbuckslist.insert(0,'starter')
	print("what is in starbuckslist",starbuckslist)
	#royallist.insert(0,'starter')
	print('what the hell is in royallist',royallist)
	print("================")
	...
	#for item in range(1,len(royallist)): #added march 16,20211:19pm
		...
		if "fallthru" in item:
			...
			item =item[-1]
			#print("item=",item)
			item = int(item) -1 #bug fix may 10th, 2021
			#print(item)
...
def switch_code_gen_2():
	...
	print("cranberries=",cranberries)
	#may 10, 2021 bug fix for using more than one numbers switch 
	#this takes care of a bug where starter is missing at front
	#causing and unwelcome index out of range errror in the parser
	if cranberries[0] != "starter":
	...
	print("what it sees in smartcasemanager",smartcasemanager)
	print('what is in einstein',einstein)
	...
	#print("einstein list",einstein)
	#print("----------------")
	print("for the code gen of lists at the top we have")
	print("einstein=",einstein)
	...
	print(case_main_body_list) #possibly missing 'starter in position 0
...
# caselists concatted to string cool
 ...
 #== LOOP
	...
	print('this is in firstpart',firstpart)
	print("=============")
	print("this is in secondpart",secondpart)
	print("==============")
	print('this is in thirdpart',thirdpart)
	print("===========")
...
def starter_sequence_mode_2():
	...
	if valve[0] == True: #meaning numbers in cases detected
		...
		british=[]
		penguin=[]
		clear_out_all_case_lists() #this is in both
...
#	mytrace('expand_thru_macro()')
#	print('expand_thru_macro1 called.....')
#	global switchcasetester
#	#print(switchcasetester)
#	change_to_into_thru()   #<====== this is where "to macro" swapped with "thru" in switch case input
#	newlist=[] #resets newlist
...
#def convert_case_numbers_to_strings1():
#	print("cherry pie baby")
#	#return
#	print("convert case numbers to strings() called")
#	mytrace('convert_case_numbers_to_strings()')
#	make_list_of_lines_using_thru_macro1()
#	expand_thru_macro1()
#	case_numbers_to_strings1()
#	print("now print the switchcasetester")
#	global switchcasetester
#	print(switchcasetester) #to see what it looks like if it looks like current unfurled input
...
#this will need to be called for each specific thru line
###==============================================================
###           expand_thru_macro()    example case 1 thru 10: does case 1:, case 2:, case 3: .. case 10:
###           this also changes to macro into thru macro 
###==============================================================
#inputnum = 1
#def expand_thru_macro1():
#	print("inside of expand thru macro1()")
#	mytrace('expand_thru_macro()')
#	global switchcasetester
#
#	####################################################
...
#	####################################################
#	change_to_into_thru()   #<====== this is where "to macro" swapped with thru
#							# in switchcasetester input
#	newlist=[] #resets newlist
#	global mouse
#	global ajax
#	global snowy
...
#		if  "thru" in line and "case" in line and "fallthru" not in line:  #only used with numbers
			...
			#yes  thru in this line",line)
			# REMOVE COLON ON THE END")
			#this makes it conditional on if case in line and colon at end")
...
#			ajax =''
			...
			# this is GENERATED case code from macro with 2 prefix tabs") 
			# this is reading out the contents of the cases one on each line
#			# LOOP ====================
#			for item in newlist:  #this list has the number in it
#				ajax += "\t\tcase " +   str(item)   + ":" + "\n"
...
#
#			# this is where the expandef macros is inserted in the line with "thru"
#			# this expands thru macro in pumpkin-falls line 286")
#			snowy=switchcasetester.replace(line, ajax)
#			switchcasetester=''
#			switchcasetester = snowy
#			print("at bottom of expand_thru_macro method")
#			print(switchcasetester)
...
#		#do a count
#		number_of_thrus=switchcasetester.count("thru")  #counts "thru" in the input switch
#		number_of_tos  =switchcasetester.counter("to")  #counts "to" in the input switch
...
#		for line in switchcasetester.splitlines():
#			#case in line     AND   either thru or to in this line
#			if "case" in line :
...
#					mycounter += 1
#				else:
#					# here it says no thru or to in case line")
#					# it's flipping it false")
...
#targetlist=[]
#targetlist.append(0)
#experimental to use to concat and add thru falling in switch case
#def sutter(x): #this should be 3
#	if targetlist[0] == 0: #first time thru
#		x =x + 1
#		x = str(x)
...
##############  I should make this a separate function ###################################
	print("THIS IS BEING DONE INSIDE OF THE FUNCTION MAGICTIMENOW()  ==")
	print("today is Thursday, May 13th, 2021 ====== looking for why a case being skipped == ")
	print("TESTING ======DUNKIN DONUTS ===== TO DETERMINE CASES AND COUNT ===")
	print("TESTING ======DUNKIN DONUTS ===== TO DETERMINE CASES AND COUNT ===")
	print("TESTING ======DUNKIN DONUTS ===== TO DETERMINE CASES AND COUNT ===")
	print("TESTING ======DUNKIN DONUTS ===== TO DETERMINE CASES AND COUNT ===")
	print("TESTING ======DUNKIN DONUTS ===== TO DETERMINE CASES AND COUNT ===")
	print("TESTING ======DUNKIN DONUTS ===== TO DETERMINE CASES AND COUNT ===")
	print("trying to analyze why lines_with_first_cases is skipping a case section today")
	print("")
...
#####################################################################
#	print("the result of DUNKINDONUTS below this line ...")
#	print("lines with case are",dunkindonuts)
#
#	print("so I can see what the computer sees and analyzes where the cases are")
#	jumbocounter=0
#	for line in switchcasetester.splitlines():
#	
#		if "default" in line:
#
#			print("default found in this line")
#			print(line)
...
#			continue
	...
	################### may 13th, 2021 coding #########################
	#print("this is testing using lists to compare if case in one line but not next line")
	#print("this is done by first using a loop to fill list")
	#print("and then compare two segements of the list at the same time")
	#print("=========================")
	#print("another test=====" )
	#print("feed each line into a growing list ")
	#testcounter=0
	#for line in switchcasetester.splitlines():
	#	list_with_code.append(line)
	#	testcounter += 1
	#	linenumber.append(testcounter)
	#	#this is jsut feeding each line into the list
		
	#print("this is to see what is in the lists of each line of code in the switchcasetester")	
	#print("this is where I am filling the list_with_code list")
	#listcounter=0	
	#for item in range(1,len(list_with_code)):
	#	listcounter += 1
	#	print(list_with_code[listcounter])
	
	################### may 13th  2021 thursday coding ################## 
	#print("this is where I am comparing if 'case' in this current line and next line")
	
	#punkcounter=1    
	#for line in switchcasetester.splitlines():
	#	if "case" in list_with_code[punkcounter] and "case" not in list_with_code[punkcounter + 1]:
		# 	print("punkcounter of first case location on line ",punkcounter)
		# 	jazz.append(punkcounter)
		# 	punkcounter += 1
		# 	continue	
		# else:
...
def herewego(): #loops and prints all main bodies
	...
	#print("length of case body list =", len(case_main_body_list))
	#print(case_main_body_list)
	print("at line 9103 looping thru case_main_body_list")
	#this loops thru the case_main_body_list
	for item in case_main_body_list:
		if counter == 0: #skips the first slot "starter"
			counter += 1 #I forgot the bloody counter
...
def switch_code_gen():
	...
	for item in range(1,len(case_main_body_list)):
		print(case_main_body_list[item])
	...
	print("we now have for the case_main_body_list_with_tail")
	print(case_main_body_list_with_tail)
	
	print("testing to see what's in this PUPPY ")
	print("case_main_body_list_with_tail")
	print("the length is",len(case_main_body_list_with_tail))
	print("I need to see what's in here with my own eyes!!!")
	print("============")
	anewcounter=0
...
#this is the input for exp for switch(exp)
	...
	#   this is printing out the caselists at the top
	###################################################
	print('was using smartcasemanager but it was polluted')
	print("einstein=",einstein)
	...
	print("einstein list",einstein)
	print("====-=====")
	print("I need to see what's inthis list this might be messing everything up")
	print("it looks like it's full of junk and needs to be emptied.")
	...
	print("what is in testlist",testlist)
	##############################################
	switchy= "switch(exp)\n" +"while True:\n\n" #=====
	##############################################
...
def endswitch(y): #pulls in sw 
	...
	if valve[0] == True: #this says numbers for cases = True
		print("we are here valve[0] = True")
		#convert_case_numbers_to_strings() #this converts the switch input for the string parser
		macro_expansion(y); y=None; del y; y = cray[0];
		flush_lists() # new just added april 7th
		parser_mode_1(y)  #this would hve done parser_mode_2
	else: # if it makes it here it's words in strings 
		flush_lists() # new just added april 7th
		parser_mode_1(y) 
...
def endswitch(y): #pulls in sw 
	...
	print("valve[0]=",valve[0])
	if valve[0] == True: #this means cases are numbers
		# does macro expansion of input switch case 
		# string stored into cray[0] 
		cherry_pie(y); y=None; del y; y = cray[0]; #back in y  
		# also stringifies numbers ie: case 1:  becomes case "1":                             
...
#this final version only does the string mode and numbers are done by making them strings
def endswitch(y): #pulls in sw 
	#just added this to make sure it's empty
	#del targetlist[:] #this is for sutter() adding numbers thru fallthrus
	#targetlist.append(0)
	...
	flow_valve_input1(y)   #puts True or False into valve[0] added April 2nd, 2021
	#####################
	# right here it's hard coded False to do numbers 
	valve[0] = False #this is hardcoded False for this part
	print("actual result should be here")
	print("the result of the case check is ...")
	print("valve[0] =", valve[0])
	#return #program should stop right here
	print("the input switch string before doing anything to it")
	#print(y)
	print("end of check what the case is either word or number")
	if valve[0] == True: #this says numbers for cases = True
		convert_case_numbers_to_strings() #this converts the switch input for the string parser
		#the function above it not being called
		print("this is after conveting input into unfurled macros")
		#return

		flush_lists() # new just added april 7th
		parser_mode_1(y)  #this would hve done parser_mode_2
	else:
		#this means case words and not numbers #it would call this function above to convert the numbers into strings and convert macros
		flush_lists() # new just added april 7th
		parser_mode_1(y) 
	#	
