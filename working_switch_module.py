# official_switch_case_silver.py  23 days ago backup from git hub 
#working_switch_module.py
...
#Insights
#Settings
#Santa_Cruz_Python_Preprocessor/official_switch_case_silver.py /
#@blakesouthwood
#Latest commit c099f7b 23 days ago
 #History
 #1 contributor
#10236 lines (7664 sloc)  302 KB
...
#===case sections three parts at once ==")
 ...
 #== LOOP
	...
	#print(switchcasetester)
	#this is where we can print out the generated python code creating the C behavior
...
def starter_sequence_mode_1():
	...
	if valve[0] == True or valve[0] == False: #case numbers if True WAS False #means cases are words like "apple pie"
		...
		#working on July 4th during loud fireworks
		#managing_nested_switch_scenario() ## new July 4th, 2021 conceptual
...
#### DETERMINE IF NESTED SWITCH ######### july 4th, 2021 9:24 pm 
def determine_if_nested_switch(y):
	print("determine if nested switch called....")
	...
	#this looks for switch in the line but endswitch can't be in this line
		if "switch" in line and "(" in line and "end" not in line:
			switchcounter += 1
	...
	# this sets the flag in nested_switch[0] if at
	# least one nested switch
	#===============================================
	...
	#print("=============////============")
	#print("testing one input string with a nested switch in it first")
	#determine_if_nested_switch(swordfish)
	#print("the result is what, should be nested switch and ..")
	#print("nested_switch[0] =",nested_switch[0])
	#print("=============////============")
...
def endswitch(y): #pulls in sw 
	...
	######## filter to detect nested switch ###########################
	########  this counts switches and endswitches ####################
	########  need at least two switches and one endswitch for True ###
	###################################################################
	determine_if_nested_switch(y)
	print("the result is what, should be nested switch and ..")
	print("nested_switch[0] =",nested_switch[0])
	if nested_switch[0] == True:
		print("nested_switch[0] == True we got one!!! ghost busters")
		print(y)
		return 
	else:
		pass
	###=========
    #so currently this just sets a flag but nothing else ... yet
    # July 4th, 2021
    ######=======================================
    # soon this will call bypass205 if nested_switch[0] is True
    # but first it needs to separate the switch with inner switches
    # into separate strings and put the inner switch methods into
    # the main switch 
    # this works in prototype mode so far
