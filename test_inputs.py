...
#import mrcoffee_mocha  #uses sutter to add numbers try string concat
#from mrcoffee_mocha  import * 

#### this one below is good onemay 27th
import official_switch_case
from official_switch_case  import *  #May 29th, 2021 flailing
...
#print("testing my generated macro expansion code from mrcoffee file may 19th")
#sw =
'''switch(exp) {  
		case '1':
		case '2':
...
def reset_sutter_and_buildstring():
	print("just reset sutter and buildstring()")
	targetlist[0] = 0
	buildstringlist[0] = 0
	
	

reset_sutter_and_buildstring()
...
#print("apple=",apple)
print("final result=")
print("result of sutter adding",targetlist[0])
...
'''
	...
	switch(exp) {
		...
		case 'starbucks':
			print('where is my mocha')
			print("and my sausage sandwich...")
			sutter(2) #this won't do anything until it is executed
