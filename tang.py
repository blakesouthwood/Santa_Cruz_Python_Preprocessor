...
#import importlib
import blender
from blender  import *  #april 29th, 2021 flailing
...
#is this skipped if use user doesn't use macros. 
#need to test it like a user might use it. 
...
clever('25') #this would change varholder[0] 

print("this  FIRST switch uses macros thru and to")
...
print("this is testing with no macros no to and no thru but it is using numbers already ")
print("in string mode unfurled but not as true numbers but as strings like  case '1': ")
print("for this one it should just add strings around the numbers")
print("and it should detect that there aren't any macros to and thru being used.")




print("TESTING SECTION SWITCH numbers but no macros")
...
'''
	switch(exp) {  
		...
		case 10:
			print('kangaroo hop hop!')
			print('taught me how  write code')
			break
