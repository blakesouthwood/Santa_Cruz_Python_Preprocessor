...
#this way I don't call this one
#was_switchcasetester = '''
#	switch(exp) {
#		case 'cafe':  
#		case 'milktoast':
#			print(\"what no sugar!\")
#			print("can we have a hotter waitress")
#			break
#
#		case 'cvs':  
#		case 'walgreens':
#			print(\"where is walgreens!\")
#			print("which is your favorite cvs")
#			break
#			
#		case 'frosty':  
#		case 'rudolph':
...
def reset_switch():
	print("reset switch")
	#working on reset switch currently
